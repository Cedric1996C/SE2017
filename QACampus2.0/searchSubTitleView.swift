...
//  QACampus2.0
//
//  Created by 王乙飞 on 2017/7/1.
//  Copyright © 2017年 Demons. All rights reserved.
//

import UIKit

protocol searchSubTitleViewDelegate: NSObjectProtocol {
    // 当前选中第index个标题的代理毁掉
    func searchSubTitleViewDidSelected(_ titleView: searchSubTitleView, atIndex: NSInteger, title: String)
}


class searchSubTitleView: UIView {
    
    // MARK:- 代理
    weak var delegate: searchSubTitleViewDelegate?
...
extension searchSubTitleView {
    @objc func subTitleClick(_ btn: UIButton) {
        ...
        //实际上 ? 代替了responsed
        delegate?.searchSubTitleViewDidSelected(self, atIndex: subTitleBtnArray.index(of: btn)!, title: btn.titleLabel?.text ?? "")
