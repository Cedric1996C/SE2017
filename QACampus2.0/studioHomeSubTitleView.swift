...
class studioHomeSubTitleView: UIView {
    
    // MARK:- 代理
    weak var delegate: studioHomeSubTitleViewDelegate?
...
// MARK:- 跳转
extension studioHomeSubTitleView {
...
extension studioHomeSubTitleView {
    @objc func subTitleClick(_ btn: UIButton) {
        ...
        //实际上 ? 代替了responsed
        delegate?.studioHomeSubTitleViewDidSelected(self, atIndex: subTitleBtnArray.index(of: btn)!, title: btn.titleLabel?.text ?? "")
